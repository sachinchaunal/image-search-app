...
const Login = () => {
  const handleOAuthLogin = (provider) => {
    if (provider === 'facebook' || provider === 'github') {
      alert('⚠️ Only Google login is currently available.\n\nFacebook and GitHub authentication are not configured yet. Please use "Continue with Google" to sign in.');
      return;
    }
    ...
    <div className="login-container">
      ...
      <div className="login-card">
        <div className="login-header">
          ...
          <p>Search and discover amazing images from Unsplash</p>
        </div>
